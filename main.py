...
def attack(char_name: str, char_class: str) -> str:
    """Здесь описана функция атаки - Attack."""
...
def defence(char_name: str, char_class: str) -> str:
    """Здесь описана функция защиты - Defence."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Здесь описана функция применения специаольного умения - Special)."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Здесь описана функция тренировки - Training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Здесь описана функция выбора персонажа - Choice character class."""
    approve_choice: str = ''
    char_class: str = ''
